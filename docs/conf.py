...
"""
program_intent_engagement documentation build configuration file.
...
VERSION = get_version('../program_intent_engagement', '__init__.py')
...
html_context = {
    ...
    "github_repo": 'program_intent_engagement',  # Repo name
...
#
# html_title = 'program_intent_engagement v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Service to manage and store learner intent to engage with a program.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'program_intent_engagement'),
                os.path.join(root_path, 'program_intent_engagement/migrations')])
