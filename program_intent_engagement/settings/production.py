...
from program_intent_engagement.settings.base import *
from program_intent_engagement.settings.utils import get_env_setting
...
# This may be overridden by the YAML in program_intent_engagement_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'PROGRAM_INTENT_ENGAGEMENT_CFG' in environ:
    CONFIG_FILE = get_env_setting('PROGRAM_INTENT_ENGAGEMENT_CFG')
